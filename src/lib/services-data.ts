...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        introSubtitle: 'Whether you\'re optimizing an existing site or designing something entirely new, we give you everything you need to move forward confidently and drive measurable business results. Built on Next.js/React, with scroll animations and performance optimization baked in from the start.',
        introBg: '#DADECF',
        category: 'Specialized Production',
        categorySlug: 'specialized-production',
        accent: '#A8885A',
      ...
      },
      {
        ...
        mobileHeroImage: `${CDN}/image/upload/q_auto,f_auto/the-pivot/mobile/video-production.jpg`,
    ...
    items: [
      {
        ...
        intro: 'AI-generated video, images, and creative content at scale. Fast, on-brand, and built to match your visual identity.',
        introLabel: "Let's Talk AI",
        headingLine1: '*AI-powered* creative production',
        introSubtitle: "From image-editing to video creation, AI is most useful when it's not a bolt-on feature, but a foundational part of how we solve real creative challenges. Think AI avatar creators, multilingual voiceover, and scroll-stopping UGC ads — production that keeps pace with every platform and language.",
        introBg: '#DADECF',
        ...
        videos: [
          ...
          { src: vid('ai-powered-creative', 'Image%20enhancements.mp4'), label: 'Image Enhancements' },
          { src: vid('ai-powered-creative', 'Translation%20and%20transcreation.mp4'), label: 'Translation & Transcreation' },
          { src: `${CDN}/video/upload/v1784240828/the-pivot/card-grid/yogurt/1.mp4`, label: 'UGC & AI Avatar Content' },
          { src: `${CDN}/video/upload/v1784288910/the-pivot/card-grid/ugc_unboxing/2.mp4`, label: 'Multilingual Voiceover' },
        ],
        mediaItems: [
          { src: vid('ai-powered-creative', 'AI%20Video%20Production.mp4'),               label: 'AI Video Production',           type: 'video', aspectRatio: '1/1' },
          { src: img('ai-powered-creative', 'Avatar%20and%20voice%20cloning.jpg'),         label: 'Avatar & Voice Cloning',        type: 'image', aspectRatio: '3/4' },
          { src: vid('ai-powered-creative', 'Brand%20imagery.mp4'),                        label: 'Brand Imagery',                 type: 'video', aspectRatio: '1/1' },
          { src: vid('ai-powered-creative', 'Translation%20and%20transcreation.mp4'),      label: 'Translation & Transcreation',   type: 'video', aspectRatio: '3/4' },
          { src: vid('ai-powered-creative', 'Image%20enhancements.mp4'),                   label: 'Image Enhancements',            type: 'video', aspectRatio: '1/1' },
          { src: img('ai-powered-creative', 'Product%20visuals.jpg'),                      label: 'Product Visuals',               type: 'image', aspectRatio: '3/4' },
          { src: img('ai-powered-creative', 'Character%20development.jpg'),                label: 'Character Development',         type: 'image', aspectRatio: '4/3' },
          { src: img('ai-powered-creative', 'Production%20at%20scale.jpg'),                label: 'Production at Scale',           type: 'image', aspectRatio: '4/3' },
          { src: `${CDN}/video/upload/v1784240828/the-pivot/card-grid/yogurt/1.mp4`, label: 'UGC & AI Avatar Content', type: 'video', aspectRatio: '4/3' },
          { src: `${CDN}/video/upload/v1784288910/the-pivot/card-grid/ugc_unboxing/2.mp4`, label: 'Multilingual Voiceover', type: 'video', aspectRatio: '4/3' },
        ],
        gridRows: [
          { count: 3, cardAspectRatio: '3/4', columns: '4fr 3fr 4fr' },
          { count: 3, cardAspectRatio: '3/4', columns: '3fr 4fr 3fr' },
          { count: 2, cardAspectRatio: '4/3', columns: 'repeat(2, 1fr)' },
          { count: 2, cardAspectRatio: '4/3', columns: 'repeat(2, 1fr)' },
        ],
        gridMaxWidth: '1000px',
      },
