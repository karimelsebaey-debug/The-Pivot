    ...
    items: [
      {
        ...
        introSubtitle: "From image-editing to video creation, AI is most useful when it's not a bolt-on feature, but a foundational part of how we solve real creative challenges.",
        introBg: '#DADECF',
