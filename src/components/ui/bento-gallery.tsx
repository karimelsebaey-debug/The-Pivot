...
type InteractiveImageBentoGalleryProps = {
...
export function InteractiveImageBentoGallery({ imageItems, title, description }: InteractiveImageBentoGalleryProps) {
  ...
  return (
    <section ref={targetRef} className="relative w-full overflow-hidden py-16 sm:py-24" style={{ backgroundColor: 'var(--color-bg)' }}>
      {title && (
